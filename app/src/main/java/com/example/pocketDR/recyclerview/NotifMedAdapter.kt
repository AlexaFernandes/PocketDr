...
class NotifMedAdapter(private val notifList: ArrayList<NotificationMedDTO>) :
    RecyclerView.Adapter<NotifMedAdapter.MyViewHolder>() {
    ...
    fun remove(idUser: String, idMed: String) {
        ...
        ref.child("caretakers").child(idUser).child("medicines").addValueEventListener(object :
            ValueEventListener {
